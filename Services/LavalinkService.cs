...
namespace X89Bot.Services
{
    public sealed class LavalinkService
    {
        ...
        public static EventId LogEvent { get; } = new EventId(1001, Program.Settings.Name);
        ...
        private Task Client_Ready(DiscordClient sender, ReadyEventArgs e)
        {
            if (Node is null)
                _ = Task.Run(async () =>
                {
                    ...
                    {
                        Discord.Logger.LogError(LogEvent, ex, Properties.Resources.ERR_LAVALINK_CONNECTION);
                        throw;
                    }
                });
        ...
        {
            Discord.Logger.LogError(LogEvent, exception, Properties.Resources.ERR_LAVALINK_PLAYBACK);
        }
    }
}